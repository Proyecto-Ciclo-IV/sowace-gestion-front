...
const Profile = () => {
  ...
  }, [dataMutation, setUserData, userData]);
  ...
  return (
    <div className='p-10 flex flex-col items-center justify-center w-full'>
      <h1 className='font-bold text-2xl text-pink-900'>Perfil de Usuario</h1>
        ...
        {queryData.Usuario.foto && !editFoto ? (
          <div className='flex flex-col items-center'>
            ...
            <button
              ...
              className='bg-purple-400 p-1 my-2 rounded-md text-white'
            >
              Cambiar imagen
            </button>
          </div>
