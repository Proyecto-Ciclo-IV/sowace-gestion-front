      ...
      <div className='p-8 font-bold text-purple-900'>
        ...
        <PrivateComponent roleList={['ADMINISTRADOR', 'LIDER']}>
          <div className='my-2 self-end'>
            <button
              type='button'
              className='bg-purple-500 text-gray-50 p-2 rounded-lg shadow-lg hover:bg-purple-400'
            >
...
const Objetivo = ({ index, _id, idProyecto, tipo, descripcion }) => {
  ...
  return (
    <div className='mx-6 my-3 bg-purple-500 p-8 rounded-lg flex flex-col items-center justify-center font-medium shadow-lg'>
      <div className='text-lg font-semibold text-gray-50'>{tipo}</div>
      <div className='font-medium text-gray-50 italic'>{descripcion}</div>
      <PrivateComponent roleList={['ADMINISTRADOR', 'LIDER']}>
...
const EditarObjetivo = ({
  ...
  return (
    <div className='p-4'>
      <h1 className='text-2xl font-bold text-pink-900'>Editar Objetivo</h1>
